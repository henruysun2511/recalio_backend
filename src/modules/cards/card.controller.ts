...
export class CardController {
  ...
  async findByDeck(
    ...
    @Query() dto: FindByDeckQueryDto,
  ) {
    return this.service.findByDeck(userId, deckId, dto.state, dto.page, dto.limit);
  }
  ...
  async getStats(
    ...
    return this.service.getStats(userId ?? currentUserId, deckId);
  }
