...
export class AiController {
  ...
  @SwaggerDoc({
    summary: 'Extract notes from text',
    bodyType: ExtractWordsDto,
    responseType: AiNoteDto,
    isArray: true,
  })
  ...
  @SwaggerDoc({
    summary: 'Generate notes from topic',
    bodyType: GenerateNotesDto,
    responseType: AiNoteDto,
    isArray: true,
  })
  ...
  @SwaggerDoc({
    summary: 'Generate synonyms and antonyms with notes',
    bodyType: RelatedNotesDto,
    responseType: RelatedNotesResponseDto,
  })
  ...
  @SwaggerDoc({
    summary: 'Process PDF document into study notes',
    responseType: ProcessDocumentNoteDto,
    isArray: true,
  })
  ...
  @SwaggerDoc({
    ...
    responseType: DetectImageResponseDto,
  })
  @UseInterceptors(FileInterceptor('file'))
  async detectImage(
    @UploadedFile(
