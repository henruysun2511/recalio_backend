...
export class CreateReportDto {
  ...
  @MaxLength(REPORT_CONSTANTS.DESC_MAX_LENGTH, {
...
export class ReportAdminDto {
  ...
  @ApiProperty({
    example: { id: 'uuid', username: 'john_doe', displayName: 'John Doe' },
  })
  reportedBy: Record<string, unknown>;

  @ApiProperty({
    example: { id: 'uuid', name: 'English Vocabulary', isBanned: false },
  })
