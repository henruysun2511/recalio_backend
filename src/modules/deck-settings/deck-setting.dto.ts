...
export class UpdateDeckSettingDto {
  ...
  @Min(DECK_SETTING_CONSTANTS.NEW_CARDS_PER_DAY_MIN, {
    message: 'Số thẻ mới mỗi ngày tối thiểu là 0',
  })
  @Max(DECK_SETTING_CONSTANTS.NEW_CARDS_PER_DAY_MAX, {
    message: 'Số thẻ mới mỗi ngày tối đa là 9999',
  })
  @Type(() => Number)
  ...
  @Min(DECK_SETTING_CONSTANTS.REVIEWS_PER_DAY_MIN, {
    message: 'Số ôn tập mỗi ngày tối thiểu là 0',
  })
  @Max(DECK_SETTING_CONSTANTS.REVIEWS_PER_DAY_MAX, {
    message: 'Số ôn tập mỗi ngày tối đa là 99999',
  })
  @Type(() => Number)
  ...
  @Min(DECK_SETTING_CONSTANTS.INTERVAL_MIN, {
    message: 'Khoảng cách tối thiểu là 0',
  })
  @Type(() => Number)
  ...
  @Min(DECK_SETTING_CONSTANTS.MODIFIER_MIN, {
    message: 'intervalModifier tối thiểu là 0',
  })
  @Max(DECK_SETTING_CONSTANTS.MODIFIER_MAX, {
    message: 'intervalModifier tối đa là 3',
  })
  @Type(() => Number)
  ...
  @Min(DECK_SETTING_CONSTANTS.MODIFIER_MIN, {
    message: 'hardInterval tối thiểu là 0',
  })
  @Max(DECK_SETTING_CONSTANTS.MODIFIER_MAX, {
    message: 'hardInterval tối đa là 3',
  })
  @Type(() => Number)
  hardInterval?: number;
  ...
  @Min(DECK_SETTING_CONSTANTS.LEECH_THRESHOLD_MIN, {
    message: 'leechThreshold tối thiểu là 1',
  })
  @Max(DECK_SETTING_CONSTANTS.LEECH_THRESHOLD_MAX, {
    message: 'leechThreshold tối đa là 99',
  })
  @Type(() => Number)
  ...
  @Min(DECK_SETTING_CONSTANTS.RETENTION_MIN, {
    message: 'requestRetention tối thiểu là 0.5',
  })
  @Max(DECK_SETTING_CONSTANTS.RETENTION_MAX, {
    message: 'requestRetention tối đa là 0.99',
  })
  @Type(() => Number)
