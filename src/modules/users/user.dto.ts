...
export class UpdateUserDto {
  ...
  @MaxLength(USER_CONSTANTS.DISPLAY_NAME_MAX_LENGTH, {
    message: 'Tên hiển thị không được quá 100 kí tự',
  })
  ...
  @MaxLength(USER_CONSTANTS.BIO_MAX_LENGTH, {
    message: 'Bio không được quá 500 kí tự',
  })
  @Transform(({ value }) => value?.trim())
  bio?: string;
  ...
  @IsOptional()
  @IsString({ message: 'Timezone phải là chuỗi kí tự' })
  timezone?: string;
}
