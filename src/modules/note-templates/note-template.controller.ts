...
export class NoteTemplateController {
    ...
    @SwaggerDoc({ summary: 'List all note templates', responseType: NoteTemplateResponseDto, isArray: true })
    async findAll() {
    ...
    @SwaggerDoc({ summary: 'Get note template by id', responseType: NoteTemplateResponseDto })
    ...
    @SwaggerDoc({ summary: 'Create note template (admin)', bodyType: CreateNoteTemplateDto, responseType: NoteTemplateResponseDto, status: 201 })
    ...
    @SwaggerDoc({ summary: 'Update note template (admin)', bodyType: UpdateNoteTemplateDto, responseType: NoteTemplateResponseDto })
    ...
    @SwaggerDoc({ summary: 'List card templates of a note template', responseType: CardTemplateResponseDto, isArray: true })
    async getCardTemplates(@Param('noteTemplateId') noteTemplateId: string) {
        return this.service.getCardTemplates(noteTemplateId);
    }

    @Get(':noteTemplateId/card-templates/:id')
    @Public()
    @ResponseMessage('Lấy card template thành công')
    @SwaggerDoc({ summary: 'Get card template by id', responseType: CardTemplateResponseDto })
    async getCardTemplateById(@Param('noteTemplateId') noteTemplateId: string, @Param('id') id: string) {
        return this.service.getCardTemplateById(noteTemplateId, id);
    }
    ...
    @SwaggerDoc({ summary: 'Create card template (admin)', bodyType: CreateCardTemplateDto, responseType: CardTemplateResponseDto, status: 201 })
    async createCardTemplate(@Param('noteTemplateId') noteTemplateId: string, @Body() dto: CreateCardTemplateDto) {
    ...
    @SwaggerDoc({ summary: 'Update card template (admin)', bodyType: UpdateCardTemplateDto, responseType: CardTemplateResponseDto })
    async updateCardTemplate(@Param('noteTemplateId') noteTemplateId: string, @Param('id') id: string, @Body() dto: UpdateCardTemplateDto) {
    ...
    async deleteCardTemplate(@Param('noteTemplateId') noteTemplateId: string, @Param('id') id: string) {
