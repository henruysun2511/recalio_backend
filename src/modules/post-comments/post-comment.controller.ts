...
export class PostCommentController {
  ...
  async findByPost(
    ...
    @Query() dto: CommentQueryDto,
  ) {
    return this.service.findByPost(postId, dto);
  }

  @Get('comments/:id/replies')
  @ResponseMessage('Lấy danh sách trả lời thành công')
  @SwaggerDoc({ summary: 'List replies of a comment' })
  async findReplies(@Param('id') id: string, @Query() dto: CommentQueryDto) {
    return this.service.findReplies(id, dto);
  }
