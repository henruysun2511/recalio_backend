import { IsString, IsOptional, IsEnum, IsInt, IsBoolean, IsNotEmpty, Min, Max } from 'class-validator';
...
export class NotificationQueryDto {
    ...
    @Min(1)
    @Max(NOTIFICATION_CONSTANTS.MAX_LIMIT, { message: `limit tối đa là ${NOTIFICATION_CONSTANTS.MAX_LIMIT}` })
    limit?: number;
}
...
export class CreateNotificationDto {
    ...
    @ApiPropertyOptional({ example: 'uuid', description: 'Bỏ trống để gửi cho tất cả user' })
    @IsOptional()
