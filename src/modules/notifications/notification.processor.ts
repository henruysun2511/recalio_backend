...
import { SendNotificationJobData, BroadcastNotificationJobData, SendEmailNotificationJobData } from '../../infrastructures/queue/producers/notification.producer';
    ...
    async process(job: Job) {
        switch (job.name) {
            ...
            case JobName.BROADCAST_NOTIFICATION: {
                ...
                this.logger.log(`Broadcasted notification to ${userIds.length} users (triggered by admin ${adminId})`);
                break;
            }
