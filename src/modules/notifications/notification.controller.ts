...
import { UpdateSettingsDto, NotificationQueryDto, CreateNotificationDto, NotificationSettingResponseDto, NotificationResponseDto } from './notification.dto';
...
export class NotificationController {
    ...
    @SwaggerDoc({ summary: 'Get notification settings', responseType: NotificationSettingResponseDto })
    ...
    @SwaggerDoc({ summary: 'Update notification settings', bodyType: UpdateSettingsDto })
    ...
    @SwaggerDoc({ summary: 'List notifications', responseType: NotificationResponseDto, isArray: true })
    ...
    @SwaggerDoc({ summary: 'Admin: send notification', bodyType: CreateNotificationDto })
