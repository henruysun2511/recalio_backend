...
export class CreateLanguageDto {
  ...
  @MaxLength(LANGUAGE_CONSTANTS.NAME_MAX_LENGTH, {
    message: 'Tên ngôn ngữ không được quá 100 kí tự',
  })
  ...
  @MaxLength(LANGUAGE_CONSTANTS.NAME_MAX_LENGTH, {
    message: 'Tên bản ngữ không được quá 100 kí tự',
  })
  @Transform(({ value }) => value?.trim())
  nativeName: string;
  ...
  @MaxLength(LANGUAGE_CONSTANTS.FLAG_EMOJI_MAX_LENGTH, {
    message: 'Flag emoji không được quá 10 kí tự',
  })
  @Transform(({ value }) => value?.trim())
  flagEmoji: string;
